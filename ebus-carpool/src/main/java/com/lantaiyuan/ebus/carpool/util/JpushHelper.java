...
public class JpushHelper {
	...
	*/
	...
	public static void main(String[] args) {
		...
		//JpushHelper.sendMessageWithRegistrationID("IOS通知-单个用户", "helloWorld", "160a3797c8338585884", LastLoginSysTypeEnum.ANDROID.value(), extras);
		JpushHelper.sendNotificationWithRegistrationID("IOS通知-单个用户", "helloWorld", extras, "160a3797c8338585884", LastLoginSysTypeEnum.ANDROID.value());
