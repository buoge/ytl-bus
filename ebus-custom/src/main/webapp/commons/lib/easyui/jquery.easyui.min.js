...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"This field is required.",invalidMessage:null,tipPosition:"bottom",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
$(this).tooltip("tip").css({color:"#f78c8c",borderColor:"#e63232",backgroundColor:"#fff"});
},onHide:function(){
$(this).tooltip("destroy");
...
}},{text:function(_949){return $(_949).datebox("options").cleanText;},handler:function(_950){$(_950).combo('setValue', '').combo('setText', '');$(this).closest("div.combo-panel").panel("close");}}],formatter:function(date){
