...
$(function() {
	...
	initDatagridgirdDrivingDecords();
});
var appName = $('#appName').val();
// 初始化initDatagridgirdDrivingDecords funtion
function initDatagridgirdDrivingDecords() {
...
function newsManageDelete(event) {
	var index = $(event.target).attr('data-index');
	$("#girdDrivingDecords").datagrid('selectRow', index);
	var delrows = $('#girdDrivingDecords').datagrid('getSelected');
	if (delrows) {
