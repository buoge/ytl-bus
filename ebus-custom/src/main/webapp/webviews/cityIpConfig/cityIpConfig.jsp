	...
	<body>
	  <!-- item-header -->
	   	<div id="tb"  class="item-header">
			...
			<span class="item-span  fl">城市名称：</span>
		    <input type="text"  class="item-input fl"   id='cityname'  size="15"/>
		...
		<div class="item-content" >
	        <table id ="girdIpConfig" >  </table>
	    </div>
	</body>
	  <!-- common footer -->
      <%@ include file="/webviews/common/footer.jsp"%>
      <script type="text/javascript" src="${appName}/commons/js/cityIpConfig/cityIpConfig.js"></script> 
</html>
