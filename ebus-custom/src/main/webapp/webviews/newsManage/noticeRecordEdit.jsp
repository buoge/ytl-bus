...
<form id="noticeRecordEditForm" method="post" enctype="multipart/form-data">   
      <input type='hidden' id="eid" name='id'/>
     
    <div class="wrapper">
        <div class="item-line crbox">
            <span class="item-spans item-w70  fl">内容：</span>
            <input type="text"  class="item-input item-w400  fl easyui-validatebox" id='acontent' size="15" name="content" data-options="required:true,validType:'length[1,60]'" style="width: 438px"/>
        </div>
        <div class="item-line crbox">
       ...
       <span class="item-spans item-w70 item-marl  fl ">&nbsp;&nbsp;&nbsp;&nbsp;</span>
            ...
            <div class="searchGeo" >
                <input type="text" id="address" class="item-input"   value=""/>
                <span class="item-minbtn" onclick="javascript:placeSearch()">定位</span>
                <span class="item-minbtn" onclick="javascript:markMap()">标记</span>
                <div class="item-row item-relative crbox">
                    <div id="result"  name="result" class="searchList"></div>
                </div>
            </div>
	...
	<div class="preview ">
        ...
        <div class="item-pad  t-c crbox " >
               <div class="item-inblock">
	               <span class="item-btn" onclick="commitNoticeRecordEdit();">保存</span>
