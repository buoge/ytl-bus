<%@ page language="java" pageEncoding="utf-8"%>
      <div class="wrapper">
      <form id="detialDrivingForm" method="post" enctype="multipart/form-data">
        <div class="item-line crbox">
           ...
           <ul class="item-ul crbox">
              ...
              <ul class="item-ul crbox">
	              <li>
					 ...
					 <input type="text"  id=bmTime" name="bmTime"  class="item-input fl"  />
			    </li>
	              <li>
           ...
           <ul class="item-ul crbox">
              ...
              <div class="item-ul  item-marb  crbox">
				...
				<input class="Wdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" id='contactTime'  name="contactTime" size="15"/>
				 <i class="Wdateico" ></i>
				</span>
			</div>
                 <div class="item-ul  item-marb crbox">
		              <span class="item-span  item-w60 fl">联系记录：</span>
						...
						<textarea  class="item-textarea" id="contactRecord"  name="contactRecord"></textarea>
						</span>
              </div>
	    </div>
