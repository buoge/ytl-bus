 ...
 * @ClassName: BookBus
 * @author Yuan.Tan
 * @date 2016年11月8日 上午11:43:55
 *
 */
@ApiModel
public class BookBus extends Model {
	private static final long serialVersionUID = -7471487335568851892L;
    ...
    private String userName;//购票人、申请人
    private Date orderTime;
    private Integer payType;//支付方式：1-支付宝 2-微信 3-其他 100-默认值无意义
    private Integer orderStatus;//订单状态(0-未支付 1-已支付 2-已取消 3-订单失效 )
    private String orderPrice;//实付款
