 ...
 */
public class SuggestionQueryModel extends BaseModel<Suggestion>{
    /**
     * 
     */
    private static final long serialVersionUID = -1715022316641417435L;
    ...
    public void setSysLastReply(String sysLastReply) {
        this.sysLastReply = sysLastReply;
    }
