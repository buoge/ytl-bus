...
public class BaseImageQueryModel extends BaseModel<BaseImageDetail>{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 3397721851488920213L;
    ...
    /**
	  ...
	  * 创建一个新的实例 BaseImageQueryModel. 
	  * <p>Title: </p>
	  * <p>Description: </p>
	  * @param type2
	  * @param cityCode2
	  */
	public BaseImageQueryModel(String type2, String cityCode2) {
		this.type = (byte) Integer.valueOf(type2).intValue();
