...
/**
 * 
 * @Title: RelRouteStationQueryModel.java
 * @Package com.lantaiyuan.ebus.custom.model
 * @Description:
 * @author yangyang
 * @date 2016年12月21日 下午4:20:41
 * @version v1.0
 */
public class RelRouteStationQueryModel extends BaseModel<RelRouteStation> {

	private static final long serialVersionUID = 6251512614930117152L;

	/**
	 * 自增主键id 表字段 : rel_route_station.id
	 */
	private Integer id;

	/**
	 * 线路id 表字段 : rel_route_station.routeId
	 */
	private String routeid;

	/**
	 * 站点id 表字段 : rel_route_station.stationId
	 */
	private String stationid;

	/**
	 * 先前站点id 表字段 : rel_route_station.previousStationId
	 */
	private Integer previousstationid;

	/**
	 * 下一站点id 表字段 : rel_route_station.nextStationId
	 */
	private Integer nextstationid;

	/**
	 * 在该线路中是几站 表字段 : rel_route_station.stationNo
	 */
	private Integer stationno;

	/**
	 * 创建时间 表字段 : rel_route_station.createTime
	 */
	private Date createtime;

	/**
	 * 城市编码 表字段 : rel_route_station.cityCode
	 */
	private String citycode;

	/**
	 * 线路方向 0-上行 1-下行 表字段 : rel_route_station.direction
	 */
	 ...
	 *
	 * @param id
	 *            the value for rel_route_station.id, 自增主键id
	 */
	 ...
	 *
	 * @param routeid
	 *            the value for rel_route_station.routeId, 线路id
	 */
	 ...
	 *
	 * @param stationid
	 *            the value for rel_route_station.stationId, 站点id
	 */
	 ...
	 *
	 * @param previousstationid
	 *            the value for rel_route_station.previousStationId, 先前站点id
	 */
	 ...
	 *
	 * @param nextstationid
	 *            the value for rel_route_station.nextStationId, 下一站点id
	 */
	 ...
	 *
	 * @param stationno
	 *            the value for rel_route_station.stationNo, 在该线路中是几站
	 */
	 ...
	 *
	 * @param createtime
	 *            the value for rel_route_station.createTime, 创建时间
	 */
	 ...
	 *
	 * @param citycode
	 *            the value for rel_route_station.cityCode, 城市编码
	 */
	 ...
	 *
	 * @param direction
	 *            the value for rel_route_station.direction, 线路方向 0-上行 1-下行
	 */
